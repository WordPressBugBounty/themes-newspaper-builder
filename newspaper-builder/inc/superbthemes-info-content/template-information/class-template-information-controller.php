...
class TemplateInformationController
{
    ...
    public static function InformationContent()
    {
        ...
        add_action('admin_footer', function () {
            $theme = wp_get_theme();
            $text = is_child_theme() ? sprintf(__("Unlock all features by upgrading to the premium edition of %1\$s and its parent theme %2\$s.", 'newspaper-builder'), $theme, wp_get_theme($theme->Template)) : sprintf(__("Unlock all features by upgrading to the premium edition of %s.", 'newspaper-builder'), $theme);
            ob_start();
?>
            <div class="superbthemes-js-information-wrapper">
                <div class="superbthemes-js-information-item">
                    ...
                    <div class="superbthemes-js-information-item-content">
                        ...
                        <a href="<?php echo esc_url(self::$ThemeLink); ?>" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", 'newspaper-builder'); ?></a>
                    </div>
                </div>
            </div>
<?php
